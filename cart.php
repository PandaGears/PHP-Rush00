	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="shopping_cart"> 
					...
					echo "<b>Like what you see?:</b>";
					}
					?>
					
					<b style="color:yellow">Shopping Cart -</b> Total Items: <?php total_items();?> Total Price: <?php total_price(); ?> <a href="index.php" style="color:white">Back to Shop</a>
